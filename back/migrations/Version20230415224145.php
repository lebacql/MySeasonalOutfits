 ...
 */
final class Version20230415224145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, id_quiz_id INT NOT NULL, question VARCHAR(255) NOT NULL, INDEX IDX_B6F7494E5BA17805 (id_quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
